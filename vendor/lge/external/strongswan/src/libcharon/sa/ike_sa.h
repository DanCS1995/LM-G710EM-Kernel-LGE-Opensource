...
struct ike_sa_t {
	...
	status_t (*set_s_nssai) (ike_sa_t *this,chunk_t s_nssai_value);
	status_t (*get_s_nssai) (ike_sa_t *this,char* s_nssai_value);
	status_t (*set_plmn_id) (ike_sa_t *this,chunk_t plmn_id);
	status_t (*get_plmn_id) (ike_sa_t *this,char* plmn_id);
