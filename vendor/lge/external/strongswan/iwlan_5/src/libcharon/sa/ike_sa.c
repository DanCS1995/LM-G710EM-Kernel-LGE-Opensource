...
static void set_dscp(private_ike_sa_t *this, packet_t *packet)
{
	...
	if (ike_cfg)
	{
        ...
        packet->set_dscp(packet, (uint8_t) property_get_int32("persist.net.wo.dscp", ike_cfg->get_dscp(ike_cfg)));
	...
	private_ike_sa_t *this, protocol_id_t protocol, u_int32_t spi)
{
	...
	if (property_get_bool("persist.net.wo.rekey_delay", 0))
	{
...
#ifdef ANDROID
	if (get_cust_setting_bool(REAUTH_DELETE_ONLY)) {
...
//changhwan.lee
	...
	if (this->task_manager->retransmit(this->task_manager, message_id) != SUCCESS)
	{
        ...
        //changhwan.lee
        strcpy(apn, (this->public.get_name(&this->public) + 4));
        //strcpy(value, "1081");
        notify_error("1081", apn);
        //changhwan.lee
