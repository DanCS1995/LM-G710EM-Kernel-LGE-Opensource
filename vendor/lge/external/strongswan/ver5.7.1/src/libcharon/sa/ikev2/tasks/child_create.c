								   ...
								   bool no_dh, bool ike_auth)
{
	...
	#if 0 /* 2017-01-02 sy.yun@lge.com LGP_DATA_IWLAN_ALLOW_ESP_DHGROUP_WHILE_REKEY_ORG [START] */
	...
	#endif /* 2017-01-02 sy.yun@lge.com LGP_DATA_IWLAN_ALLOW_ESP_DHGROUP_WHILE_REKEY_ORG [END] */
