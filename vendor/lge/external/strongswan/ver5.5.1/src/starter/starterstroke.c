...
static void add_end(stroke_msg_t **msg, size_t offset, starter_end_t *conn_end)
{
    ...
    push_string_end(msg, offset, idr_apn, conn_end->idr_apn);
	...
	push_string_end(msg, offset, pcscf, conn_end->pcscf);
	push_string_end(msg, offset, imei, conn_end->imei);
	push_string_end(msg, offset, sourceif, conn_end->sourceif);
	push_string_end(msg, offset, intnetmask, conn_end->intnetmask);
	push_string_end(msg, offset, intsubnet, conn_end->intsubnet);
